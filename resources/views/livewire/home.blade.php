<div x-data="{ open: false }" 
    class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 flex flex-col relative overflow-hidden">

    <!-- Background image (transparan) -->
    <div class="absolute inset-0 bg-no-repeat bg-cover bg-center opacity-20 z-0"
         style="background-image: url('{{ asset('storage/gambar/lobby.jpg') }}');">
    </div>

    <!-- Main content di atas background -->
    <div class="relative z-10">
            ...
            <div class="max-w-7xl mx-auto flex justify-between items-center py-3 px-2 md:px-4">
                ...
                <div class="hidden md:flex space-x-2 md:space-x-3">
                    ...
                    <a class="transition hover:scale-105 bg-green-500 hover:bg-green-600 text-white px-3 md:px-4 py-2 rounded-lg font-semibold shadow text-sm md:text-base"
                       wire:navigate href="{{ route('filament.mahasiswa.auth.register') }}">Register Akun Mahasiswa</a>
                </div>
        ...
        <section
            ...
            <div class="w-full lg:pr-16 flex flex-col justify-center text-center lg:text-left animate-fade-in-up">
                <h1 class="text-3xl md:text-5xl font-extrabold text-indigo-800 mb-3 md:mb-4 leading-tight drop-shadow">
                    SMART CLASS</h1>
                <p class="text-base md:text-lg text-gray-700 mb-6 max-w-xl mx-auto lg:mx-0 text-justify">
                    Media Pembelajaran Interaktif dengan mendorong partisipasi aktif mahasiswa dalam kemudahan pembelajaran dasar pemrograman, serta dilengkapi modul dan soal kuis yang inovatif sehingga lebih asik, menarik dan mudah dipahami.
                </p>
            </div>
        ...
        <section
            ...
            <div
                ...
                <p class="text-gray-600 text-sm md:text-base">Materi pembelajaran yang dikemas secara efisien dan mudah dipahami mahasiswa, mendukung penguasaan HTML, CSS, dan JavaScript.</p>
            </div>
            <div
                class="bg-white rounded-2xl shadow-xl p-6 md:p-10 flex flex-col items-center text-center hover:scale-[1.03] transition-all duration-300 border border-indigo-50">
                ...
                <p class="text-gray-600 text-sm md:text-base">Kuis Interaktif berbasis gamifikasi untuk mengukur softskill dan hardskill mahasiswa secara real-time.</p>
            </div>
        </section>
